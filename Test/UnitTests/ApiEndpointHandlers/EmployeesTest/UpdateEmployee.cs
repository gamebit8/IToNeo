...
namespace IToNeo.UnitTests.ApiEndpointHandlers.EmployeesTest
{
    public class UpdateEmployee
    {
        ...
        [Fact]
        public async Task NotNullResultAfterUpdateEmployee()
        {
            var request = new UpdateEmployeeRequest<UpdateEmployeeRequestBody>();

            var handler = new IToNeo.WebAPI.ApiEndpoints.V1.Employees.Update(_mockEmployeeRepository.Object, _mockMapper.Object, _mockLogger.Object)
            {
